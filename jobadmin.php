...
if (!empty($_POST["filtro_posizione_lavorativa"])) {
   if($_POST["filtro_posizione_lavorativa"]=='cuoco')
       $f3="cameriere";
   else $f3="cuoco";
}
...
<input type="radio" name="filtro_posizione_lavorativa" <?php if (isset($_POST['filtro_posizione_lavorativa']) && $_POST['filtro_posizione_lavorativa']=="cuoco") echo "checked";?> value="cuoco">Cuoco
<input type="radio" name="filtro_posizione_lavorativa" <?php if (isset($_POST['filtro_posizione_lavorativa']) && $_POST['filtro_posizione_lavorativa']=="cameriere") echo "checked";?> value="cameriere">Cameriere
<br><br>
